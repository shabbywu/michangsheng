...
namespace KBEngine
{
	...
	public class Blowfish
	{
		...
		public Blowfish(int keySize = 16)
		{
			...
			Blowfish.rngCsp.GetBytes(this._key);
			this.init();
		}
		...
		private void init()
		{
			...
			{
				this._isGood = false;
				Dbg.ERROR_MSG("Blowfish::init: invalid length " + this._key.Length);
				return;
			}
			this.P = (Blowfish._P.Clone() as uint[]);
			this.S = (Blowfish._S.Clone() as uint[,]);
			short num = 0;
			for (short num2 = 0; num2 < 18; num2 += 1)
			{
				uint num3 = 0U;
				for (short num4 = 0; num4 < 4; num4 += 1)
				{
					num3 = (num3 << 8 | (uint)this._key[(int)num]);
					num += 1;
					if ((int)num >= this._key.Length)
					{
						num = 0;
					}
				}
				this.P[(int)num2] = (this.P[(int)num2] ^ num3);
			}
			uint num5 = 0U;
			uint num6 = 0U;
			for (short num2 = 0; num2 < 18; num2 += 2)
			{
				this.encipher(ref num5, ref num6);
				this.P[(int)num2] = num5;
				this.P[(int)(num2 + 1)] = num6;
			}
			for (short num2 = 0; num2 < 4; num2 += 1)
			{
				for (num = 0; num < 256; num += 2)
				{
					this.encipher(ref num5, ref num6);
					this.S[(int)num2, (int)num] = num5;
					this.S[(int)num2, (int)(num + 1)] = num6;
				}
			}
			this._isGood = true;
		}
		...
		private uint f(uint x)
		{
			...
			x >>= 8;
			ushort num2 = (ushort)(x & 255U);
			x >>= 8;
			ushort num3 = (ushort)(x & 255U);
			x >>= 8;
			ushort num4 = (ushort)(x & 255U);
		...
		public void encipher(byte[] data, int length)
		{
			...
			for (int i = 0; i < length; i += 8)
			{
				if (num != 0UL)
				{
					ulong num2 = BitConverter.ToUInt64(data, i);
					ulong num3 = num2 ^ num;
					num = num2;
					data[i] = (byte)num3;
					data[i + 1] = (byte)(num3 >> 8);
					data[i + 2] = (byte)(num3 >> 16);
					data[i + 3] = (byte)(num3 >> 24);
					data[i + 4] = (byte)(num3 >> 32);
					data[i + 5] = (byte)(num3 >> 40);
					data[i + 6] = (byte)(num3 >> 48);
					data[i + 7] = (byte)(num3 >> 56);
				}
				else
				{
					num = BitConverter.ToUInt64(data, i);
				}
				uint num4 = (uint)((int)data[i] << 24 | (int)data[i + 1] << 16 | (int)data[i + 2] << 8 | (int)data[i + 3]);
				uint num5 = (uint)((int)data[i + 4] << 24 | (int)data[i + 5] << 16 | (int)data[i + 6] << 8 | (int)data[i + 7]);
				this.encipher(ref num4, ref num5);
				data[i] = (byte)(num4 >> 24);
				data[i + 1] = (byte)(num4 >> 16);
				data[i + 2] = (byte)(num4 >> 8);
				data[i + 3] = (byte)num4;
				data[i + 4] = (byte)(num5 >> 24);
				data[i + 5] = (byte)(num5 >> 16);
				data[i + 6] = (byte)(num5 >> 8);
				data[i + 7] = (byte)num5;
			}
		}
		...
		private void encipher(ref uint xl, ref uint xr)
		{
			uint num = xl;
			uint num2 = xr;
			for (short num3 = 0; num3 < 16; num3 += 1)
			{
				num ^= this.P[(int)num3];
				num2 = (this.f(num) ^ num2);
				uint num4 = num;
				num = num2;
				num2 = num4;
			}
		...
		public string encipher(string data)
		{
			...
			this.encipher(bytes, bytes.Length);
		...
		public void decipher(byte[] data, int startIndex, int length)
		{
			...
			for (int i = 0; i < length; i += 8)
			{
				...
				uint num3 = (uint)((int)data[num2] << 24 | (int)data[num2 + 1] << 16 | (int)data[num2 + 2] << 8 | (int)data[num2 + 3]);
				uint num4 = (uint)((int)data[num2 + 4] << 24 | (int)data[num2 + 5] << 16 | (int)data[num2 + 6] << 8 | (int)data[num2 + 7]);
				this.decipher(ref num3, ref num4);
				data[num2] = (byte)(num3 >> 24);
				data[num2 + 1] = (byte)(num3 >> 16);
				data[num2 + 2] = (byte)(num3 >> 8);
				data[num2 + 3] = (byte)num3;
				data[num2 + 4] = (byte)(num4 >> 24);
				data[num2 + 5] = (byte)(num4 >> 16);
				data[num2 + 6] = (byte)(num4 >> 8);
				data[num2 + 7] = (byte)num4;
				if (num != 0UL)
				{
					ulong num5 = BitConverter.ToUInt64(data, num2) ^ num;
					data[num2] = (byte)num5;
					data[num2 + 1] = (byte)(num5 >> 8);
					data[num2 + 2] = (byte)(num5 >> 16);
					data[num2 + 3] = (byte)(num5 >> 24);
					data[num2 + 4] = (byte)(num5 >> 32);
					data[num2 + 5] = (byte)(num5 >> 40);
					data[num2 + 6] = (byte)(num5 >> 48);
					data[num2 + 7] = (byte)(num5 >> 56);
				}
				num = BitConverter.ToUInt64(data, num2);
			}
		}
		...
		private void decipher(ref uint xl, ref uint xr)
		{
			uint num = xl;
			uint num2 = xr;
			for (short num3 = 17; num3 > 1; num3 -= 1)
			{
				num ^= this.P[(int)num3];
				num2 = (this.f(num) ^ num2);
				uint num4 = num;
		...
		public string decipher(string data)
		{
			...
			this.decipher(array, 0, array.Length);
