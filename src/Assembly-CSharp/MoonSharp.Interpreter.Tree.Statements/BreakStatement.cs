...
internal class BreakStatement : Statement
{
	...
	public BreakStatement(ScriptLoadingContext lcontext)
		: base(lcontext)
	{
		m_Ref = NodeBase.CheckTokenType(lcontext, TokenType.Break).GetSourceRef();
	...
	public override void Compile(ByteCode bc)
	{
		using (bc.EnterSource(m_Ref))
		{
			...
			{
				throw new SyntaxErrorException(base.Script, m_Ref, "<break> at line {0} not inside a loop", m_Ref.FromLine);
			}
