...
public class ObjCustomizationShirts : MonoBehaviour
{
	...
	private void Start()
	{
		...
		{
			swipeCtrl = ((Component)this).gameObject.AddComponent<SwipeControlCustomizationShirts>();
		}
	...
	private void Update()
	{
		...
		for (int i = 0; i < obj.Length; i++)
		{
			...
			if (ShopManagerFull.AktivanCustomizationTab == 2 && ShopManagerFull.AktivanItemMajica != swipeCtrl.maxValue - swipeCtrl.currentValue)
			{
				ShopManagerFull.AktivanItemMajica = swipeCtrl.maxValue - swipeCtrl.currentValue;
