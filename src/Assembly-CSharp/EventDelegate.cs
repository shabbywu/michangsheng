...
public class EventDelegate
{
	...
	public override bool Equals(object obj)
	{
		...
		if (obj is Callback)
		{
			...
			if ((Object)(object)mTarget == (Object)(object)val)
			{
		...
		if (obj is EventDelegate)
		{
			...
			if ((Object)(object)mTarget == (Object)(object)eventDelegate.mTarget)
			{
		...
		if (mMethod != null)
		{
			...
			else
			{
				...
				catch (ArgumentException ex)
				{
					...
					text = ((!((Object)(object)mTarget == (Object)null)) ? string.Concat(text, ((object)mTarget).GetType(), ".", mMethod.Name) : (text + mMethod.Name));
